...
check "calculators.php?calc=spells"        "Spells"
check "calculators.php?calc=equipment"     "Equipment Damage"
check "wiki_spells.php"                     "Spells"        "Fatal"
check "wiki_summon.php"                     "Summon Creature"
check "wiki_experience.php"                 "129,389,800"   "Fatal"
